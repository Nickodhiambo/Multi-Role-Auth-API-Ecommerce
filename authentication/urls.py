...
#     path('api/v1/logout/', LogoutView, name='logout'),
#     path('api/v1/verify-email/', VerifyEmailView, name='verify'),
#     path('api/v1/switch-accounts/', SwitchAccountView, name='switch')
# ]